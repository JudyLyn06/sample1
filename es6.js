...
//Before sending data, use stringify to convery a JS object into a JSON string
...
//before sending data, use stringify to convert a JS object into a JSON string
const studentStr = JSON.stringify(student)

console.log(studentStr)

//Upon receiving data, JSON string can be converted to a JS object with parse
...
/*console.log(person1.greeting())*/
  ...
  let person5 = [
  { firstName: 'John', lastName: 'Smith', location: 'Japan'},
  { firstName: 'Jane', lastName: 'Smith', location: 'Japan'},
  { firstName: 'Jollibee', lastName: 'Smith', location: 'Japan'}
  ]
/*
console.log(person5[1].firstName)
*/
...
studentGrades.forEach(function(student){
  const average = ((student.Q1 + student.Q2 + student.Q3 + student.Q4) / 4).toFixed(1);
